...
const DICT = {
  eng: {
    ...
    "profile.placeholder.interests":
      "Write only what you want to find (programs, research, location). Do not list what you do not want.",
    ...
    "profile.action.save_all": "Save Profile",
    "profile.state.saved": "Saved",
    "profile.state.unsaved": "Unsaved changes",
    "profile.saved_all": "Profile saved",
    "profile.unsaved.title": "Unsaved Changes",
    "profile.unsaved.message": "You have unsaved profile changes. What do you want to do?",
    "profile.unsaved.discard": "Close without saving",
    "profile.unsaved.cancel": "Cancel",
    "profile.unsaved.save_close": "Save and close",
  ...
  rus: {
    ...
    "common.ai_short": "ИИ",
    "profile.placeholder.interests":
      "Пишите только то, что ищете (программы, исследования, локация). Не перечисляйте то, что не ищете.",
    ...
    "profile.action.save_all": "Сохранить профиль",
    "profile.state.saved": "Сохранено",
    "profile.state.unsaved": "Есть несохраненные изменения",
    "profile.saved_all": "Профиль сохранен",
    "profile.unsaved.title": "Несохраненные изменения",
    "profile.unsaved.message": "В профиле есть несохраненные изменения. Что сделать?",
    "profile.unsaved.discard": "Закрыть без сохранения",
    "profile.unsaved.cancel": "Отмена",
    "profile.unsaved.save_close": "Сохранить и закрыть",
  ...
  kz: {
    ...
    "common.ai_short": "ЖИ",
    "profile.placeholder.interests":
      "Тек іздейтін нәрселеріңізді жазыңыз (бағдарламалар, зерттеу, орналасу). Іздемейтін нәрселерді жазбаңыз.",
    ...
    "profile.action.save_all": "Профильді сақтау",
    "profile.state.saved": "Сақталды",
    "profile.state.unsaved": "Сақталмаған өзгерістер бар",
    "profile.saved_all": "Профиль сақталды",
    "profile.unsaved.title": "Сақталмаған өзгерістер",
    "profile.unsaved.message": "Профильде сақталмаған өзгерістер бар. Не істейміз?",
    "profile.unsaved.discard": "Сақтамай жабу",
    "profile.unsaved.cancel": "Бас тарту",
    "profile.unsaved.save_close": "Сақтап жабу",
