...
const DEFAULT_EXAM_CONFIG = {
    ...
    GERMAN_ABITUR_CERT: {
      ...
      labels: { eng: "German Abitur Certificate", rus: "Немецкий аттестат Abitur" },
      input_mode: "flag",
      min: 0,
      max: 1,
      type: "bool",
    ...
    OSSD_CERT: {
      ...
      labels: { eng: "OSSD (Ontario Secondary School Diploma)", rus: "OSSD (диплом о среднем образовании Онтарио)" },
      input_mode: "flag",
      min: 0,
      max: 1,
      type: "bool",
...
const EXAM_LABELS_I18N = {
  ...
  rus: {
    ...
    IBDIPLOMA: "Диплом IB",
    ALEVELCERT: "Оценки A-Level",
    HKDSELEVEL: "Уровень HKDSE",
