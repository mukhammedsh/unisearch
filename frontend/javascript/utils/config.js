...
const EXAM_LABELS_I18N = {
  ...
  rus: {
    ...
    APCALCULUSAB: "AP: математический анализ AB",
    APCALCULUSBC: "AP: математический анализ BC",
    APCOMPUTERSCIENCEA: "AP: информатика A",
    APPHYSICSCMECHANICS: "AP: физика C — механика",
    APPHYSICSCELECTRICITYMAGNETISM: "AP: физика C — электричество и магнетизм",
    APCHEMISTRY: "AP: химия",
    APBIOLOGY: "AP: биология",
    IBMATHEMATICSHL: "IB: математика HL",
    IBPHYSICSHL: "IB: физика HL",
    IBCHEMISTRYHL: "IB: химия HL",
    IBBIOLOGYHL: "IB: биология HL",
    IBCOMPUTERSCIENCEHL: "IB: информатика HL",
    ALEVELMATHEMATICS: "A-Level: математика",
    ALEVELFURTHERMATHEMATICS: "A-Level: углубленная математика",
    ALEVELPHYSICS: "A-Level: физика",
    ALEVELCHEMISTRY: "A-Level: химия",
    ALEVELBIOLOGY: "A-Level: биология",
    ALEVELCOMPUTERSCIENCE: "A-Level: информатика",
    HKDSECHINESELANGUAGE: "HKDSE: китайский язык",
    HKDSEENGLISHLANGUAGE: "HKDSE: английский язык",
    HKDSEMATHEMATICS: "HKDSE: математика",
    HKDSEELECTIVE1: "HKDSE: выборочный предмет 1",
    HKDSEELECTIVE2ORM1M2OTHERLANGUAGE: "HKDSE: выборочный предмет 2 / M1 / M2 / другой язык",
    ...
    HKDSEICT: "HKDSE: информационно-коммуникационные технологии",
    HKDSECITIZENSHIPANDSOCIALDEVELOPMENT: "HKDSE: граждановедение и социальное развитие",
