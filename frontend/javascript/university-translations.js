...
const TRANSLATIONS = {
  rus: {
    ...
    words: {
      ...
      acceptance_rate: "Доля зачисления",
  ...
  kz: {
    ...
    words: {
      ...
      acceptance_rate: "Қабылдау үлесі",
...
const UNIVERSITY_NAMES = {
  rus: {
    ...
    "astana-it-university-kaz-astana": "Astana IT University",
  },
  kz: {
